...
cuentas = Account.create([
    {:accountid => '0017500000GA9E4AAL', :status => 'Validada', :dni => '71903170', :nombres => 'Elvis Lazaro', :apellido_paterno => 'Espinoza', :apellido_materno => 'Camargo', :birthdate => '1990-07-05', :tup_dni => '71903170', :tup_nombres => 'Elvis Lazaro', :tup_apellido_paterno => 'Espinoza', :tup_apellido_materno => 'Camargo', :tup_birthdate => '1994-07-05'},
